    ...
    <div className="App">
      ...
      <div className="card">
        <button
          ...
          disabled={
            isSome(game.currentPlayer) &&
            game.currentPlayer.unwrap() !== PlayerBoardPosition.TOP
          }
        >
          Make top move
        </button>
          ...
          {JSON.stringify(
            game
              ...
              .map((b) =>
                [
                  ...b.top.map((d) =>
                    d.map((v) => (isSome(v) ? v.value : 'EMPTY'))
                  ),
                  ...b.bottom.map((d) =>
                    d.map((v) => (isSome(v) ? v.value : 'EMPTY'))
                  ),
        ...
        <button
          ...
          disabled={
            isSome(game.currentPlayer) &&
            game.currentPlayer.unwrap() !== PlayerBoardPosition.BOTTOM
          }
        >
          Make bottom move
        </button>
